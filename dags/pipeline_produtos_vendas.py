...
def extract_produtos(**context):
    ...
    logging.info(f"Validando existência do arquivo: {file_path}")
...
def generate_report(**context):
    """Task 6: Gerar relatório consolidado"""
...
def detect_low_performance(**context):
    """Task 7 (Bônus): Detectar produtos com baixa performance"""
...
# Tarefa de extração de produtos
...
# Tarefa de detecção de baixa performance (Bônus)
